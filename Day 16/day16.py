...
def part2():
    ...
    for position in range(0, len(number_rows_ints[0])):
        ...
        for number in [number_row[position] for number_row in number_rows_ints]:
            ...
            # add the list of possible fields to the map for this position
    ...
    # field from all the other positions. Keep doing that until all position only have one possible field
    ...
    result = 1
    for index, num in enumerate(my_rows):
